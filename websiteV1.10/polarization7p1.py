...
df2=pandas.read_csv("Data/Cs7p1.csv")
source2= ColumnDataSource(df2)
# dividing data to get line graph from separate parts

dfdiff=pandas.read_csv('Data/cs7p16s.csv').sort_values(by=['wavelength'],ignore_index=True)
...
x_slider = RangeSlider(start=1100, end=1800, value=(1100,1800), step=.1, title="Wavelength(nm)",width=510, align="center" )
...
for x,y in zip(x_data,y_data):
    p.line( x =x, y=y ,color="navy", legend_label='7p1/2' )
