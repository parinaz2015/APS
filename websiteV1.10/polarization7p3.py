...
dfdiff=pandas.read_csv('Data/cs7p3m1.csv').sort_values(by=['wavelength'],ignore_index=True)
...
for x,y in zip(x_data,y_data):
    p.line( x =x, y=y ,color="green", legend_label='7p3/2,|m|=3/2' )
...
for x,y in zip(x_data_diff,y_data_diff):
    p.line( x =x, y=y ,color="navy", legend_label='7p3/2,|m|=1/2' )
