...
df2=pandas.read_csv("Data/Cs6p1.csv")
...
for x,y in zip(x_data,y_data):
    p.line(x= x, y=y ,color="#ff005b", legend_label='6s', line_width=1, alpha=1, muted_alpha=0 )

x_data,y_data = data_function(df2)
for x,y in zip(x_data,y_data):
    p.line( x =x, y=y ,color="navy", legend_label='6p1/2',line_width=1, alpha=1, muted_alpha=0 )
...
for x,y in zip(x_data_diff,y_data_diff):
    p.line( x =x, y=y ,color="green", line_width=1, alpha=1, legend_label='diff',muted_alpha=0 )
